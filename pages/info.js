  ...
  return (
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <p className={styles.text}>Our ceremony will be a Catholic mass. St. Rita offers plenty of safe street parking as well as off-street parking in their school lot.</p>
        <ChurchMap/>
