  ...
  return (
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <p className={styles.text}>Paradigm Gardens<br/>1131 S South Rampart Street, New Orleans, LA, USA</p> 
        <p className={styles.text}>Add Event To Calendar</p>
        <p className={styles.text}>map</p>
      </main>
    </div>
  )
